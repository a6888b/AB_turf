...
if data_all_api.data_is_save(): 
    continuer = input("Les donne sont deja enregistrer pour les match d'aujord'hui, voulez vous quand meme continuer (y/N): ")
    if continuer == "y":
        os.remove(data_all_api.NAME_FILE_DATE)
